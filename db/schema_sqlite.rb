...
ActiveRecord::Schema[8.2].define(version: 2026_07_06_160000) do
  ...
  create_table "cards", id: :uuid, force: :cascade do |t|
    ...
    t.string "priority", limit: 255, default: "none", null: false
  ...
  create_table "daily_updates", id: :uuid, force: :cascade do |t|
    t.uuid "account_id", null: false
    t.text "blockers", limit: 65535
    t.text "completed_yesterday", limit: 65535
    t.datetime "created_at", null: false
    t.text "planned_today", limit: 65535
  ...
  create_table "github_pull_requests", id: :uuid, force: :cascade do |t|
    t.uuid "account_id", null: false
    t.uuid "board_id"
    t.uuid "card_id"
    t.datetime "created_at", null: false
  ...
  create_table "github_repositories", id: :uuid, force: :cascade do |t|
    t.uuid "account_id", null: false
  ...
  create_table "github_user_links", id: :uuid, force: :cascade do |t|
    t.uuid "account_id", null: false
    t.datetime "created_at", null: false
    t.bigint "github_id"
    t.string "github_login", limit: 255, null: false
    t.datetime "updated_at", null: false
    t.uuid "user_id", null: false
  ...
  create_table "report_snapshots", id: :uuid, force: :cascade do |t|
    t.uuid "account_id", null: false
    t.uuid "board_id"
    t.datetime "created_at", null: false
    t.json "metrics"
