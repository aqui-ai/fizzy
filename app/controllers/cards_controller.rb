class CardsController < ApplicationController
  wrap_parameters :card, include: %i[ title description image priority due_on created_at last_active_at ]
  ...
  private
    ...
    def card_params
      params.expect(card: [ :title, :description, :image, :priority, :due_on, :created_at, :last_active_at ])
    end
end
